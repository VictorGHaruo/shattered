...
def maping(grounds):
    ...
    grid = [
        ...
        "                              LGGGGGGGGGGGGGGGGGR                                                                                   C                          CC",
        "                    TMMMMP    LGGGGGGGGGGGGGGGGGR                                                                                   C                          CC",
        "                              LGGGGGGGGGGGGGGGGGR   TMP                                                                             B                          CC",
        "XXXXXXXXXXXXXXXD              LGGGGGGGGGGGGGGGGGR        EXXXXXXXXXXXXXXXXXXD           EXXXD                       EXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXXXXXXX",
